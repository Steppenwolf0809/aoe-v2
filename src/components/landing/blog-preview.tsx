          ...
          {posts.map((post) => (
            <motion.div key={post.slug} variants={cardVariants}>
              <Link href={`/blog/${post.slug}`} className="block h-full group">
                <Card className="h-full overflow-hidden hover:bg-white/[0.05] hover:border-white/[0.12] transition-all duration-200 cursor-pointer">
                  ...
                  >
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1 text-xs font-medium text-white bg-white/20 backdrop-blur-sm rounded-full border border-white/10">
                        {post.category}
                      </span>
                    </div>
                  </div>
                  ...
                  <CardContent className="p-5">
                    ...
                    {/* Title */}
                    <h3 className="text-base font-semibold text-white mb-2 leading-snug group-hover:text-accent-primary transition-colors duration-200">
                      {post.title}
                    </h3>
