...
export const metadata: Metadata = {
  ...
  description:
    'Calcula la contribución al Consejo Provincial de Pichincha para transferencias de inmuebles. Fórmula: 10% del impuesto de alcabala + $1.60. Herramienta gratuita.',
  keywords: [
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Se calcula aplicando el 10% sobre el valor pagado por el impuesto de alcabala, más un valor fijo de $1.60. Es decir: (Alcabala × 10%) + $1.60.',
  },
  {
      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[var(--text-secondary)] text-lg max-w-2xl mx-auto">
            ...
            inmuebles. Fórmula: 10% del impuesto de alcabala + $1.60.
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-semibold text-white">Fórmula de Cálculo</h3>
              </div>
              <div className="p-4 bg-purple-500/5 rounded-lg border border-purple-500/20">
                <code className="text-sm text-purple-300 block text-center">
                  (Alcabala × 10%) + $1.60
                </code>
              </div>
              <div className="mt-4 space-y-2 text-sm text-[var(--text-secondary)]">
                <p>
                  <strong className="text-white">Paso 1:</strong> Calcular el impuesto de alcabala
                </p>
                <p>
                  <strong className="text-white">Paso 2:</strong> Tomar el 10% del valor de la
                  alcabala
                </p>
                <p>
                  <strong className="text-white">Paso 3:</strong> Sumar $1.60 (valor fijo)
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-semibold text-white">Impuestos Relacionados</h3>
              </div>
              <div className="space-y-3 text-sm">
                <div className="p-3 bg-white/5 rounded-lg">
                  <p className="text-white font-medium mb-1">Alcabala (Municipio)</p>
                  <p className="text-[var(--text-secondary)]">1% sobre el valor de transferencia</p>
                </div>
                <div className="p-3 bg-purple-500/5 rounded-lg border border-purple-500/20">
                  <p className="text-white font-medium mb-1">Consejo Provincial</p>
                  <p className="text-[var(--text-secondary)]">10% de la alcabala + $1.60</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-white mb-1">¿Necesita calcular la Alcabala?</h3>
        ...
        {/* Ejemplo práctico */}
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-white mb-8 text-center">Ejemplo Práctico</h2>
          <div className="max-w-3xl mx-auto bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-semibold text-white mb-4">Datos del Ejemplo</h3>
                <div className="space-y-3 text-sm">
              ...
              <div>
                <h3 className="font-semibold text-white mb-4">Cálculo de Impuestos</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between py-2 border-b border-white/10">
                  ...
                  <div className="flex justify-between py-2 border-t-2 border-purple-500/30 pt-3">
                    ...
                    <span className="font-bold text-purple-400">$101.60</span>
                  </div>
                </div>
              </div>
            </div>
